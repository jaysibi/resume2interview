...
- Name: test_troubleshooting_frontend.spec.ts >> Section 5 – Frontend Rendering & Routing >> route /upload renders a submit/analyze button
- Location: test_troubleshooting_frontend.spec.ts:177:7
...
Locator: getByRole('button', { name: /analyze|submit/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /analyze|submit/i }).first()
