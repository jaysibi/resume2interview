...
- Name: test_troubleshooting_frontend.spec.ts >> Section 5 – Frontend Rendering & Routing >> route /upload renders UploadPage with file input
- Location: test_troubleshooting_frontend.spec.ts:165:7
