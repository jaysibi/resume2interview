...
- Name: test_troubleshooting_frontend.spec.ts >> Section 5 – Frontend Rendering & Routing >> landing page renders visible content (not blank)
- Location: test_troubleshooting_frontend.spec.ts:135:7

# Error details

```
Error: Landing page appears blank — React may not be mounting
