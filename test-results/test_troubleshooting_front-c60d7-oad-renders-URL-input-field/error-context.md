...
- Name: test_troubleshooting_frontend.spec.ts >> Section 5 – Frontend Rendering & Routing >> route /upload renders URL input field
- Location: test_troubleshooting_frontend.spec.ts:171:7
...
Locator: locator('input[type="url"], input[placeholder*="url" i], input[placeholder*="job" i]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[type="url"], input[placeholder*="url" i], input[placeholder*="job" i]').first()
