...
- Name: test_troubleshooting_frontend.spec.ts >> Section 5 – Frontend Rendering & Routing >> no JavaScript errors on landing page load
- Location: test_troubleshooting_frontend.spec.ts:142:7

# Error details

```
Error: JavaScript errors on load: The requested module '/src/services/api.ts?t=1777808205324' does not provide an export named 'Application'
