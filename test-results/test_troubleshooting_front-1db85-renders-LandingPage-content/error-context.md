...
- Name: test_troubleshooting_frontend.spec.ts >> Section 5 – Frontend Rendering & Routing >> route / renders LandingPage content
- Location: test_troubleshooting_frontend.spec.ts:158:7
...
Locator: getByRole('link', { name: /get started|upload|tailor/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /get started|upload|tailor/i }).first()
